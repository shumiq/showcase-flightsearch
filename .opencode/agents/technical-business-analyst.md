...
4. **Create a Ticket**: Use the appropriate skill:
   - Use `create-story-ticket` for new features or enhancements. Include a summary, acceptance criteria, technical notes, and an effort estimate (e.g., small/medium/large).
   - Use `create-bug-ticket` for bugs. Include reproduction steps, expected vs actual behavior, environment, technical root cause if found, and suggested fix.
